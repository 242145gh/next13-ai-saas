...
const instructionMessage: ChatCompletionRequestMessage = {
  role: "system",
  content: "Your name is Vladimir Putin. You must answer only as Vladimir Putin for explanations."
};
  ...
  try {
    ...
    if (HerosChatCount) {
      ...
      await prismadb.herosChatCount.create({
        data: { HeroName: "Vladimir Putin", NumberOfMessages: 1 },
      });
    }
